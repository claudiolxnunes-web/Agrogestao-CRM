...
// === NOVOS ITENS: Metas & Carteira ===
const metasMenuItems = [
  { icon: Target, label: "Metas Representantes", path: "/metas" },
  { icon: BarChart3, label: "Meta Regional", path: "/regional" },
  { icon: ShoppingCart, label: "Pedidos em Carteira", path: "/pedidos" },
];
...
function DashboardLayoutContent({
  ...
  const activeMenuItem = menuItems.find(item => item.path === location) ||
    metasMenuItems.find(item => item.path === location);
